...
/**
 * @type {(a: {x:number, y:number, z:number}, b: {x:number, y:number, z:number}, c: {x:number, y:number, z:number}, rayOrigin: {x:number, y:number, z:number}, rayDirection: {x:number, y:number, z:number}, backfaceCulling: boolean) => {x:number, y:number, z:number}}
 */
export const intersectRayTriangle = bvhtree.BVH.intersectRayTriangle;

/**
 * @type {BVHTree}
 */
export default bvhtree.BVH;